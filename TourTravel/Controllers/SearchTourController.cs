...
namespace TourTravel.Controllers
{
    ...
    public class SearchTourController : Controller
    {
        ...
        public SearchTourController(IHttpClientFactory httpClientFactory, ApiUrlOptions apiOptions)
        {
        ...
        {
            var apiUrl = $"{_baseUrl}/api/package/getPackageList?cityId={cityId}&checkInDate={checkInDate}&checkOutDate={checkOutDate}&maxPerson={maxPerson}";
